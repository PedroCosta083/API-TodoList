...
import pedro.costa.TaskManagerAPI.repository.TaskRepositoryTest__TestContext001_ApplicationContextInitializer;
...
public class AotTestContextInitializers__Generated {
  public static Map<String, Supplier<ApplicationContextInitializer<? extends ConfigurableApplicationContext>>> getContextInitializers(
    ...
    map.put("pedro.costa.TaskManagerAPI.repository.TaskRepositoryTest", () -> new TaskRepositoryTest__TestContext001_ApplicationContextInitializer());
    return map;
  }
  ...
  public static Map<String, Class<? extends ApplicationContextInitializer<?>>> getContextInitializerClasses(
    ...
    map.put("pedro.costa.TaskManagerAPI.repository.TaskRepositoryTest", TaskRepositoryTest__TestContext001_ApplicationContextInitializer.class);
    return map;
  }
}

 ...
 */
@Generated
public class TaskRepositoryTest__TestContext001_ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new TaskRepositoryTest__TestContext001_BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new TaskRepositoryTest__TestContext001_BeanFactoryRegistrations().registerAliases(beanFactory);
  }
